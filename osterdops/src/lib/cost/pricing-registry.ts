...
export const PRICING_REGISTRY: Record<string, ModelPricing> = {
  ...
  "gemini-flash-latest": createPricingEntry({
    ...
    description: "Latest Google Gemini Flash production model",
  }),
  "gemini-3.8-flash": createPricingEntry({
    ...
    cachedInputPerMillionUsd: 0.025,
    description: "Frontier Google Gemini 3.8 Flash model",
  }),
  "gemini-3.6-flash": createPricingEntry({
    ...
    fallbackModel: "gemini-flash-latest",
    cachedInputPerMillionUsd: 0.025,
    description: "Google Gemini 3.6 Flash reasoning model",
  }),
  "gemini-3.5-flash-lite": createPricingEntry({
    ...
    description: "Google Gemini 3.5 Flash Lite high-throughput model",
  }),
