...
export const MODEL_CAPABILITIES_REGISTRY: Record<string, ModelCapabilities> = {
  ...
  "command-r-plus-08-2024": {
    ...
    description: "Enterprise-optimized RAG and multi-step tool use powerhouse with 128K context",
  },
  "command-r-08-2024": {
    provider: "cohere",
    ...
    supportedParameters: ["temperature", "top_p", "max_tokens", "stop", "stream"],
    fallbackModel: "gpt-4o-mini",
    description: "Cost-efficient workhorse optimized for enterprise search, RAG, and automated workflows",
  },
  "embed-english-v3.0": {
    provider: "cohere",
