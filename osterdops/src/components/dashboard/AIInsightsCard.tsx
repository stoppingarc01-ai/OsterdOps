      ...
      <div className="grid grid-cols-12 gap-3 items-center z-10">
        <div className="col-span-7 space-y-3">
          <p className="text-xs text-[#c5c9d6] leading-relaxed">
            You can save <span className="text-[#dfba82] font-bold">$742/month</span> by routing 40% of <span className="font-mono text-white">gpt-4o</span> calls to <span className="font-mono text-white">gpt-4o-mini</span>.
          </p>
