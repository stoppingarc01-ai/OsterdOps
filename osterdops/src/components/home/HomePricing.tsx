  ...
  const tiers = [
    {
      ...
      priceMonthly: `$${PRICING_PLANS.free.priceMonthly}`,
      priceAnnual: "$0",
      period: "forever free",
      desc: PRICING_PLANS.free.description,
      highlighted: false,
      tag: null,
      quotaBadge: `${(PRICING_PLANS.free.limits.monthlyRequestLimit / 1000).toFixed(0)}k requests / mo`,
      features: [
        `${PRICING_PLANS.free.limits.monthlyRequestLimit.toLocaleString()} requests / month included`,
        `${PRICING_PLANS.free.limits.maxProjects} Project & ${PRICING_PLANS.free.limits.maxProviderConnections} Provider Connections`,
        "Pre-Flight Velocity Rate Limiting",
