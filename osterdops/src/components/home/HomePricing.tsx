  ...
  const tiers = [
    {
      ...
      highlighted: false,
      tag: "7 DAYS FREE",
      quotaBadge: `${PRICING_PLANS.trial.limits.monthlyRequestLimit.toLocaleString("en-US")} reqs / 50k tokens`,
      features: [
        ...
        `${PRICING_PLANS.trial.limits.monthlyRequestLimit.toLocaleString("en-US")} requests / 50k tokens included`,
    ...
    },
    {
      ...
      features: [
        `${PRICING_PLANS.growth.limits.monthlyRequestLimit.toLocaleString("en-US")} requests / month included`,
    ...
    },
    {
      ...
      features: [
        ...
        "Full Audit Log Export & VPC Deployment Support",
