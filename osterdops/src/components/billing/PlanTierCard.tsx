...
export function PlanTierCard() {
  const features = [
    "50M Included Monthly Proxy Tokens",
    "100 Engineering Team Seats",
    "14 Direct Model & APM Connectors",
    "Real-time Automated Budget Enforcements",
    "24/7 Dedicated SLA & On-Call Escalation",
  ];
    ...
    <div className="p-5 bg-[#0d0f18] border border-[#1d202e] rounded-2xl space-y-4">
      ...
      <div>
        <div className="text-2xl font-bold text-white tracking-tight">
          $149 <span className="text-xs font-normal text-[#8e93a6]">/ month</span>
        </div>
        <p className="text-xs text-[#8e93a6] mt-0.5">
          Renews automatically on <span className="text-white font-medium">May 25, 2025</span>.
        </p>
      </div>
      ...
      >
        ...
        <span>Upgrade to Custom Enterprise</span>
      </button>
    </div>
  );
}
